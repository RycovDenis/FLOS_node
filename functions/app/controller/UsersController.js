...
exports.confirm_user =function (req,res) {
    ...
    if(typeof req !== 'undefined'){
        ...
        if(email!==null&&uphone!==null){
            ...
            //     },
            // };
            // var send_sms = new HTTPClient(options);
            // send_sms.request('/sys/send.php?login=vargar929&psw=v0Vqla20&phones=+'+uphone+'&mes=Код верификации:'+ver_code+'!&translit=1', function (err, res, body) {
